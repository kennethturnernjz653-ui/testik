  ...
  var e = {
    ...
    168: function (e, t, n) {
      ...
      !(function () {
        function e(e) {
          var t = "";
          if ((t = window.location.origin ? window.location.origin : ("").concat(window.location.protocol, "://").concat(window.location.host), e && "string" == typeof e)) if (0 === e.indexOf("/")) t += e; else try {
            var n = new URL(e);
        ...
        !(function () {
          ...
          if (!p || "single" !== p.load) {
            if (d) {
              ...
              if (m) try {
                ...
                if (g && "function" == typeof URLSearchParams) {
                  var y = new URLSearchParams(g.replace(/^[^\?]+\??/, "")), h = y.get("token");
                  h && (p.token = h);
                  var T = y.get("spa");
                  p.spa = null === T || "true" === T;
                }
            ...
            if (s && p && p.token) {
              ...
              var L = p && (void 0 === p.spa || !0 === p.spa), C = p.send && p.send.to ? p.send.to : void 0 === p.version ? "https://cloudflareinsights.com/cdn-cgi/rum" : null, P = function (r) {
                var a = (function (r) {
          ...
          function I() {
            if (p && p.serverTiming) {
              for (var e = [], t = 0, n = ["navigation", "resource"]; t < n.length; t++) for (var r = n[t], i = 0, o = s.getEntriesByType(r); i < o.length; i++) {
                ...
                if (u) {
                  ...
                  for (var g = 0, y = u; g < y.length; g++) {
                    var h = y[g], T = h.name, w = h.description, S = h.duration;
    ...
    752: function (e, t) {
      ...
      (t.__esModule = !0, t.sendObjectBeacon = void 0, t.sendObjectBeacon = function (e, t, n, r, i) {
        ...
        var o = i || (t.siteToken && t.versions.fl ? ("/cdn-cgi/rum?").concat(e) : ("/cdn-cgi/beacon/performance?").concat(e)), a = !0;
        ...
        if (navigator && "function" == typeof navigator.sendBeacon && a && r) {
          t.st = 1;
          var u = JSON.stringify(t), s = navigator.sendBeacon && navigator.sendBeacon.bind(navigator);
    ...
    104: function (e, t) {
      !(function (e) {
        ...
        var t, n, r, i, o, a = function () {
          ...
          try {
            for (; e && 9 !== e.nodeType; ) {
              var r = e, i = r.id ? "#" + r.id : u(r) + (r.classList && r.classList.value && r.classList.value.trim() && r.classList.value.trim().length ? "." + r.classList.value.trim().replace(/\s+/g, ".") : "");
        ...
        }, K = [2500, 4000], Y = {}, Z = [800, 1800], $ = function e(t) {
        ...
        (e.CLSThresholds = A, e.FCPThresholds = B, e.FIDThresholds = M, e.INPThresholds = U, e.LCPThresholds = K, e.TTFBThresholds = Z, e.onCLS = function (e, t) {
              ...
              var n, r = p("CLS", 0), i = 0, o = [], a = function (e) {
                (e.forEach(function (e) {
                  if (!e.hadRecentInput) {
                    ...
                    i && e.startTime - n.startTime < 1000 && e.startTime - t.startTime < 5000 ? (i += e.value, o.push(e)) : (i = e.value, o = [e]);
                  }
              ...
              if (e.entries.length) {
                ...
                if (t) {
                  var n = t.activationStart || 0, r = e.entries[e.entries.length - 1], i = r.url && performance.getEntriesByType("resource").filter(function (e) {
                    return e.name === r.url;
                  })[0], o = Math.max(0, t.responseStart - n), c = Math.max(o, i ? (i.requestStart || i.startTime) - n : 0), u = Math.max(c, i ? i.responseEnd - n : 0), f = Math.max(u, r ? r.startTime - n : 0), d = {
                    element: s(r.element),
                    timeToFirstByte: o,
          ...
          ee(function (t) {
            (!(function (e) {
              if (e.entries.length) {
                var t = e.entries[0], n = t.activationStart || 0, r = Math.max(t.domainLookupStart - n, 0), i = Math.max(t.connectStart - n, 0), o = Math.max(t.requestStart - n, 0);
                e.attribution = {
                  waitingTime: r,
                  dnsTime: i - r,
                  connectionTime: o - i,
