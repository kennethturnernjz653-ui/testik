!(function (e, t) {
  ...
  })(u || (u = {})), (C = e.OhlcStudyPlotStyle || (e.OhlcStudyPlotStyle = {})).OhlcBars = "ohlc_bars", C.OhlcCandles = "ohlc_candles", (function (e) {
    (e.Auto = "auto", e.Tiny = "tiny", e.Small = "small", e.Normal = "normal", e.Large = "large", e.Huge = "huge");
  })(S || (S = {})), (p = e.StudyInputType || (e.StudyInputType = {})).Integer = "integer", p.Float = "float", p.Price = "price", p.Bool = "bool", p.Text = "text", p.Symbol = "symbol", p.Session = "session", p.Source = "source", p.Resolution = "resolution", p.Time = "time", p.BarTime = "bar_time", p.Color = "color", p.Textarea = "text_area", (function (e) {
  ...
  })(P || (P = {})), (L = e.StudyTargetPriceScale || (e.StudyTargetPriceScale = {}))[L.Right = 0] = "Right", L[L.Left = 1] = "Left", L[L.NoScale = 2] = "NoScale", (function (e) {
    (e[e.Right = 0] = "Right", e[e.Left = 1] = "Left", e[e.None = 2] = "None");
  })(A || (A = {})), (w = e.FilledAreaType || (e.FilledAreaType = {})).TypePlots = "plot_plot", w.TypeHlines = "hline_hline", (function (e) {
  ...
  })(O || (O = {})), (R = e.ConnectionStatus || (e.ConnectionStatus = {}))[R.Connected = 1] = "Connected", R[R.Connecting = 2] = "Connecting", R[R.Disconnected = 3] = "Disconnected", R[R.Error = 4] = "Error", (function (e) {
    (e[e.LIMIT = 1] = "LIMIT", e[e.MARKET = 2] = "MARKET", e[e.STOP = 3] = "STOP", e[e.STOPLIMIT = 4] = "STOPLIMIT");
  })(D || (D = {})), (V = e.OrderType || (e.OrderType = {}))[V.Limit = 1] = "Limit", V[V.Market = 2] = "Market", V[V.Stop = 3] = "Stop", V[V.StopLimit = 4] = "StopLimit", (function (e) {
    (e[e.BUY = 1] = "BUY", e[e.SELL = -1] = "SELL");
  })(k || (k = {})), (E = e.Side || (e.Side = {}))[E.Buy = 1] = "Buy", E[E.Sell = -1] = "Sell", (function (e) {
  ...
  })(W || (W = {})), (M = e.OrderStatus || (e.OrderStatus = {}))[M.Canceled = 1] = "Canceled", M[M.Filled = 2] = "Filled", M[M.Inactive = 3] = "Inactive", M[M.Placing = 4] = "Placing", M[M.Rejected = 5] = "Rejected", M[M.Working = 6] = "Working", (B = e.OrderStatusFilter || (e.OrderStatusFilter = {}))[B.All = 0] = "All", B[B.Canceled = 1] = "Canceled", B[B.Filled = 2] = "Filled", B[B.Inactive = 3] = "Inactive", B[B.Rejected = 5] = "Rejected", B[B.Working = 6] = "Working", (function (e) {
    (e[e.Order = 1] = "Order", e[e.Position = 2] = "Position");
  })(N || (N = {})), (function (e) {
    (e[e.ORDER = 1] = "ORDER", e[e.POSITION = 2] = "POSITION");
  })(U || (U = {})), (x = e.ParentType || (e.ParentType = {}))[x.Order = 1] = "Order", x[x.Position = 2] = "Position", x[x.IndividualPosition = 3] = "IndividualPosition", (function (e) {
  ...
  })(j || (j = {})), (z = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {}))[z.LimitPrice = 1] = "LimitPrice", z[z.StopPrice = 2] = "StopPrice", z[z.TakeProfit = 3] = "TakeProfit", z[z.StopLoss = 4] = "StopLoss", z[z.Quantity = 5] = "Quantity", (function (e) {
    (e[e.ERROR = 0] = "ERROR", e[e.SUCCESS = 1] = "SUCCESS");
  })(G || (G = {})), ($ = e.NotificationType || (e.NotificationType = {}))[$.Error = 0] = "Error", $[$.Success = 1] = "Success", (function (e) {
    (e[e.Demo = 1] = "Demo", e[e.Real = 0] = "Real");
  })(J || (J = {})), (q = e.OrderOrPositionMessageType || (e.OrderOrPositionMessageType = {})).Information = "information", q.Warning = "warning", q.Error = "error", (function (e) {
  ...
  const Ve = class {
    ...
    _render(e, t) {
      ...
      }, this._options.saved_data_meta_info && (o[this._id].chartContentExtendedData = this._options.saved_data_meta_info)); else if (!this._options.load_last_chart && !this._options.symbol) throw new Error("Symbol is not defined: either 'symbol' or 'load_last_chart' option must be set");
  ...
  (e.version = De, e.widget = Ve, Object.defineProperty(e, "__esModule", {
    value: !0
  }));
});
